        ...
        <section id="header">
                        ...
                        <nav class="navbar navbar-default zero_mp ">
                            ...
                            <div class="collapse navbar-collapse zero_mp" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right main_menu">
                                    <li><a href="#header"> <%String id=(String)session.getAttribute("user");  
           ...
           // out.println("record inserted successfully 2");
            ...
            out.print("Hello "+name);
                                    ...
                                    <li><a href="makeorder.jsp">Orders</a></li>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="notes">
                                ...
                                <div class="note blue">
                                    ...
                                    <a href="status.jsp"><img src="img/ladies wear.jpg" alt=""></a>
                                </div>
                                <div class="note red">
                                    <div class="img_overlay">
                                        <p>check out status</p>
                                    </div>
                                    <a href="status.jsp"><img src="img/mens wear.jpg" alt=""></a>
                                </div>
                                <div class="note green">
                                    <div class="img_overlay">
                                        <p>check out status</p>
                                    </div>
                                    <a href="status.jsp"><img src="img/blouse-back-neck-design.jpg" alt=""></a>
                                </div>
                                <div class="note yellow">
                                    <div class="img_overlay">
                                        <p>check out status</p>
                                    </div>
                                    <a href="status.jsp"><img src="img/wedding wear.jpg" alt=""></a>
                                </div>
                                <div class="note black">
                                    <div class="img_overlay">
                                        <p>check out status</p>
                                    </div>
                                    <a href="status.jsp"><img src="img/brides.jpg" alt=""></a>
                                </div>
                            </div>
                            <!--End of notes-->
                        </div>
